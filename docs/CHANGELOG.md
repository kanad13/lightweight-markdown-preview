...
- Renamed package from `lightweight-markdown-viewer` to `lightweight-markdown-preview` to match repository and folder names
- Updated display name from "Lightweight Markdown Viewer" to "Lightweight Markdown Preview" for consistency
